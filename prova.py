...
def new_par(pop, f, limit, i_parameter, population, best):
    ...
    d = pop[randint(0, population - 1)][i_parameter]
    e = pop[randint(0, population - 1)][i_parameter]
    #return (a + f*(b + c - d - e)) % limit
...
def differentialAlgorithm(model, target, img, iterations, population, f, range_pixel, range_rgb, dict):
    ...
    for i in tqdm(range(0, iterations)):
        ...
        for p in tqdm(range(0, population)):
            ...
            new = new_par(pop, f, range_pixel, 0, population, best), new_par(pop, f, range_pixel, 1, population, best), new_par(pop, f, range_rgb, 2, population, best), new_par(pop, f, range_rgb, 3, population, best), new_par(pop, f, range_rgb, 4, population, best), \
                new_par(pop, f, range_pixel, 5, population, best), new_par(pop, f, range_pixel, 6, population, best), new_par(pop, f, range_rgb, 7, population, best), new_par(pop, f, range_rgb, 8, population, best), new_par(pop, f, range_rgb, 9, population, best), \
                new_par(pop, f, range_pixel, 10, population, best), new_par(pop, f, range_pixel, 11, population, best), new_par(pop, f, range_rgb, 12, population, best), new_par(pop, f, range_rgb, 13, population, best), new_par(pop, f, range_rgb, 14, population, best), \
                new_par(pop, f, range_pixel, 15, population, best), new_par(pop, f, range_pixel, 16, population, best), new_par(pop, f, range_rgb, 17, population, best), new_par(pop, f, range_rgb, 18, population, best), new_par(pop, f, range_rgb, 19, population, best), \
                new_par(pop, f, range_pixel, 20, population, best), new_par(pop, f, range_pixel, 21, population, best), new_par(pop, f, range_rgb, 22, population, best), new_par(pop, f, range_rgb, 23, population, best), new_par(pop, f, range_rgb, 24, population, best)
        ...
        for p in tqdm(range(0, population)):
            if value[p][target] < old_value[p][target]:
                ...
                if get_max_class_new(old_value[p], dict) != target:
                    print(old_value[p])
                    best_int = []
                    for i in range(0, len(new_pop[p])):
                        best_int.append(int(new_pop[p][i]))
                    return best_int
    ...
    for p in range(1, population):
        if old_value[p][target] < best_value[target]:
            best = pop[p]
            best_value = old_value[p]
...
start_img_index = 10 #number of the first image used in cifar10
end_img_index = 20 #last number (NOT incluted)
